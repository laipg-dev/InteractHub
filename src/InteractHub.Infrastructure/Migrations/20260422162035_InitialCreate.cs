...
namespace InteractHub.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PostReportSummaries",
                columns: table => new
                {
                    PostId = table.Column<int>(type: "int", nullable: false),
                    TotalReports = table.Column<int>(type: "int", nullable: false),
                    SpamCount = table.Column<int>(type: "int", nullable: false),
                    OffensiveCount = table.Column<int>(type: "int", nullable: false),
                    FakeNewsCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostReportSummaries", x => x.PostId);
                    table.ForeignKey(
                        name: "FK_PostReportSummaries_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "a1111111-b222-3333-c444-555555555555", "Admin", "ADMIN" },
                    { "2", "b1111111-b222-3333-c444-555555555555", "User", "USER" }
                });
